...
WINDOW* buildhelppad(const char* path) {
	...
	incolor(pad, color.pair.help.keyword, attribute.help.keyword, "v%s", snake_version.version);
	waddstr(pad, ".");
	...
	hp_add(pad, ""); wprintw(pad, "%s [-h] [-l] [-p <uint>] [-l <uint>] [-t <uint>] [-c]", snake_version.execname);
