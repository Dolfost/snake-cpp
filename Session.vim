...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 105 + 69) / 139)
exe 'vert 2resize ' . ((&columns * 106 + 69) / 139)
argglobal
balt main.hpp
setlocal fdm=manual
setlocal fde=0
...
silent! normal! zE
let &fdl = &fdl
let s:l = 86 - ((30 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 86
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 106 + 69) / 139)
exe 'vert 2resize ' . ((&columns * 32 + 69) / 139)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
silent! normal! zE
let &fdl = &fdl
let s:l = 108 - ((33 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 108
...
set winwidth=1
exe 'vert 1resize ' . ((&columns * 105 + 69) / 139)
exe 'vert 2resize ' . ((&columns * 33 + 69) / 139)
argglobal
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 125 + 69) / 139)
exe 'vert 2resize ' . ((&columns * 13 + 69) / 139)
argglobal
...
set winwidth=1
exe 'vert 1resize ' . ((&columns * 125 + 69) / 139)
exe 'vert 2resize ' . ((&columns * 86 + 69) / 139)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 526 - ((48 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 526
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 138 + 69) / 139)
exe 'vert 2resize ' . ((&columns * 0 + 69) / 139)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 239 - ((23 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 239
...
33
normal! zo
let s:l = 75 - ((24 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 75
